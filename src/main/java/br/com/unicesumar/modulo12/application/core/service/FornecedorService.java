...
public class FornecedorService implements FornecedorServicePort{
	...
	public void setFornecedorCrudPort(FornecedorCrudPort fornecedorCrudPort) {
	...
	public Fornecedor removerPor(Integer id) {
		Fornecedor fornecedorParaRemocao = buscarPor(id);
		this.fornecedorCrudPort.removerPor(id);
		return fornecedorParaRemocao;
	}
